...
export const STATUS_COLORS = {
  ...
  Spedito: 'bg-cyan-500/20 text-cyan-200 border-cyan-500/50',
...
export const STATUS_SELECT_CLASSES = {
  ...
  Spedito:
    'bg-cyan-200 text-cyan-950 dark:bg-cyan-800/90 dark:text-cyan-50 border-cyan-300/80 dark:border-cyan-500/50',
